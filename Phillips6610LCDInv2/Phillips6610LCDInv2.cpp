...
Phillips6610LCDInv2::Phillips6610LCDInv2()
{
...
void Phillips6610LCDInv2::shiftBits(byte b) 
{
  byte Bit;
...
void Phillips6610LCDInv2::sendData(byte data) {
  CLK0
  SDA1
  CLK1
  shiftBits(data);
...
void Phillips6610LCDInv2::sendCMD(byte data) {
  CLK0
  SDA0
  CLK1
  shiftBits(data);
...
void Phillips6610LCDInv2::lcd_set_box(byte x1, byte y1, byte x2, byte y2)
{
...
void Phillips6610LCDInv2::lcd_clear(byte color, byte x1, byte y1, byte x2, byte y2)
{
...
void Phillips6610LCDInv2::lcd_init()
{
  // Initial state
  CS1
  CS0
...
void Phillips6610LCDInv2::lcd_Sleep()
{
  sendCMD(DISPOFF);
  sendCMD(SLEEPIN);
  lcd_BacklightOff();
...
void Phillips6610LCDInv2::lcd_Wake()
{
  lcd_BacklightOn();
  sendCMD(SLEEPOUT);
  sendCMD(DISPON);
...
void Phillips6610LCDInv2::lcd_BacklightOn()
{
  BL1
}

void Phillips6610LCDInv2::lcd_BacklightOff()
{
  BL0
}


void Phillips6610LCDInv2::draw_text_line(byte fcolor, byte bcolor,byte x, byte y,char c)
{
  unsigned int i;
...
void Phillips6610LCDInv2::lcd_draw_text(byte fcolor, byte bcolor, byte x, byte y,char *text)
{
  byte c;
  byte t;
  unsigned int i;
...
void Phillips6610LCDInv2::lcd_put_pixel(byte color, byte x, byte y)
{
  unsigned int icolor;
  icolor = ~color;
