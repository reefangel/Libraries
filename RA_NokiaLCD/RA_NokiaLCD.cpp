...
//    	delay(20);
//    	SendCMD(0x26); //Set Default Gamma
//    	SendData(0x04);
//    	SendCMD(0xB1);
//    	SendData(0x0C);
//    	SendData(0x14);
//    	SendCMD(0xC0); //Set VRH1[4:0] & VC[2:0] for VCI1 & GVDD
//    	SendData(0x1C);
//    	SendData(0x05);
//    	SendCMD(0xC1); //Set BT[2:0] for AVDD & VCL & VGH & VGL
//    	SendData(0x02);
//    	SendCMD(0xC5); //Set VMH[6:0] & VML[6:0] for VOMH & VCOML
//    	SendData(0x29);   //29
//    	SendData(0x33);  //43
//    	SendCMD(0xC7);
//    	SendData(0x40);
//    	SendCMD(0x3a); //Set Color Format
//    	SendData(0x05);
//    	SendCMD(0x2A); //Set Column Address
//    	SendData(0x00);
//    	SendData(0x00);
//    	SendData(0x00);
//    	SendData(0x7F);
//    	SendCMD(0x2B); //Set Page Address
//    	SendData(0x00);
//    	SendData(0x00);
//    	SendData(0x00);
//    	SendData(0x9F);
//    	SendCMD(0x36); //Set Scanning Direction
//    	SendData(0xC8);
//    	SendCMD(0xB7); //Set Source Output Direction
//    	SendData(0x00);
//    	SendCMD(0xf2); //Enable Gamma bit
//    	SendData(0x01);
//    	SendCMD(0xE0);
//    	SendData(0x36);//p1
//    	SendData(0x29);//p2
