...
#ifndef __RA_SUNLOCATION_H__
#define __RA_SUNLOCATION_H__

#include "Globals.h"
#include "InternalEEPROM.h"

class RA_SunLocation
{
  public:
    RA_SunLocation();
    ...
    inline int GetRiseHour()
    {
      return m_SunriseHour;
    }

    inline int GetRiseMinute()
    {
      return m_SunriseMin;
    }

    inline int GetSetHour()
    {
      return m_SunsetHour;
    }

    inline int GetSetMinute()
    {
      return m_SunsetMin;
    }

    inline unsigned long GetSunRise()
    {
      return m_rise;
    }

    inline unsigned long GetSunSet()
    {
      return m_set;
    }
