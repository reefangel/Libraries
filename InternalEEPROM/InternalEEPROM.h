...
class InternalEEPROMClass {
    public:
        ...
        uint8_t PWMSlopeStart6_read();
        void PWMSlopeStart6_write(const uint8_t value);
        uint8_t PWMSlopeEnd6_read();
        void PWMSlopeEnd6_write(const uint8_t value);
        uint8_t PWMSlopeDuration6_read();
        void PWMSlopeDuration6_write(const uint8_t value);
        uint8_t PWMSlopeStart7_read();
        void PWMSlopeStart7_write(const uint8_t value);
        uint8_t PWMSlopeEnd7_read();
        void PWMSlopeEnd7_write(const uint8_t value);
        uint8_t PWMSlopeDuration7_read();
        void PWMSlopeDuration7_write(const uint8_t value);
        uint8_t PWMSlopeStart8_read();
        void PWMSlopeStart8_write(const uint8_t value);
        uint8_t PWMSlopeEnd8_read();
        void PWMSlopeEnd8_write(const uint8_t value);
        uint8_t PWMSlopeDuration8_read();
        void PWMSlopeDuration8_write(const uint8_t value);
        uint8_t PWMSlopeStart9_read();
        void PWMSlopeStart9_write(const uint8_t value);
        uint8_t PWMSlopeEnd9_read();
        void PWMSlopeEnd9_write(const uint8_t value);
        uint8_t PWMSlopeDuration9_read();
        void PWMSlopeDuration9_write(const uint8_t value);
        uint8_t PWMSlopeStart10_read();
        void PWMSlopeStart10_write(const uint8_t value);
        uint8_t PWMSlopeEnd10_read();
        void PWMSlopeEnd10_write(const uint8_t value);
        uint8_t PWMSlopeDuration10_read();
        void PWMSlopeDuration10_write(const uint8_t value);
        uint8_t PWMSlopeStart11_read();
        void PWMSlopeStart11_write(const uint8_t value);
        uint8_t PWMSlopeEnd11_read();
        void PWMSlopeEnd11_write(const uint8_t value);
        uint8_t PWMSlopeDuration11_read();
        void PWMSlopeDuration11_write(const uint8_t value);
        uint8_t PWMSlopeStart12_read();
        void PWMSlopeStart12_write(const uint8_t value);
        uint8_t PWMSlopeEnd12_read();
        void PWMSlopeEnd12_write(const uint8_t value);
        uint8_t PWMSlopeDuration12_read();
        void PWMSlopeDuration12_write(const uint8_t value);
        uint8_t PWMSlopeStart13_read();
        void PWMSlopeStart13_write(const uint8_t value);
        uint8_t PWMSlopeEnd13_read();
        void PWMSlopeEnd13_write(const uint8_t value);
        uint8_t PWMSlopeDuration13_read();
        void PWMSlopeDuration13_write(const uint8_t value);
        uint8_t PWMSlopeStart14_read();
        void PWMSlopeStart14_write(const uint8_t value);
        uint8_t PWMSlopeEnd14_read();
        void PWMSlopeEnd14_write(const uint8_t value);
        uint8_t PWMSlopeDuration14_read();
        void PWMSlopeDuration14_write(const uint8_t value);
        uint8_t PWMSlopeStart15_read();
        void PWMSlopeStart15_write(const uint8_t value);
        uint8_t PWMSlopeEnd15_read();
        void PWMSlopeEnd15_write(const uint8_t value);
        uint8_t PWMSlopeDuration15_read();
        void PWMSlopeDuration15_write(const uint8_t value);
