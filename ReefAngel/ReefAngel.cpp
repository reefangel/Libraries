...
//			else if (o_portid>=OVERRIDE_CHANNEL0 && o_portid<=OVERRIDE_CHANNEL5) // Dimming Expansion channel 0-5
//				ReefAngel.PWM.SetChannelOverride(o_portid-OVERRIDE_CHANNEL0,o_value);
			break;
		}
		}
	}
