...
void ReefAngelClass::Draw2014Main()
{
	...
	byte PUMP_COLORS[] = {COLOR_DARKGREEN,COLOR_DARKGOLDENROD,COLOR_DARKGOLDENROD,COLOR_NAVY,COLOR_MEDIUMPURPLE,COLOR_HOTPINK,COLOR_HOTPINK,COLOR_SLATEGREY,COLOR_SLATEGREY,COLOR_INDIANRED,COLOR_SLATEGREY,COLOR_SLATEGREY,COLOR_SLATEGREY,COLOR_SLATEGREY};
